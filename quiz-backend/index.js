...
// Helper to save data file (declare before any use)
const saveData = () => {
  fs.writeFileSync(
    DATA_FILE,
...
if (fs.existsSync(DATA_FILE)) {
  ...
  // Preload a default course if no data.json exists
  courses = [
    {
      id: "c1",
...
// Calculate quiz score based on answers array
...
// 3️⃣ Submit Answers / Update Progress
